...
namespace _3.PresentationLayers.Views
{
    public partial class Form_TacGia : Form
    {
        ...
        public void LoadData()
        {
            ...
            dtg_show.Rows.Clear();
            foreach(var a in tacGiaService.GetAll())
            {
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(tacGiaService.Add(new TacGium()
                {
        ...
        private void btn_sua_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                MessageBox.Show(tacGiaService.Update(SelectId,new TacGium()
                {
        ...
        private void btn_xoa_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                MessageBox.Show(tacGiaService.Delete(SelectId));
                LoadData();
            }
            else
            {
